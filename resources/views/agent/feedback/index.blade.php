    ...
    layui.use(['index','laydate','form','table'], function () {
        ...
        function load() {
            ...
            table.render({
                ...
                , url: '/agent/feedback/data'
                , cols: [[
                    {type: 'checkbox', fixed: 'left'}
                    , {field: 'id', width: 60, title: 'ID', sort: true}
                    , {field: 'account_number', title: '用户账户', minWidth: 150}
                    , {field: 'content', title: '留言内容' , width : 120}
                    , {field: 'create_time', title: '留言时间', minWidth: 150}
                    , {field: 'reply_content', title: '回复内容' , width : 120}
                    , {field: 'reply_time', title: '回复时间' , width : 120}
