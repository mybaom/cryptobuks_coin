...
class MicroOrderController extends Controller
{
    ...
    public function submit(Request $request)
    {
        ...
        $match_id = $request->input('match_id', 2);
        ...
        try {
            ...
            $seconds1 = MicroSecond::where('seconds', $seconds)->select('min')->get();
            
            if($number<$seconds1[0]->min){
                 throw new \Exception($seconds."秒交易最低下单数量为".$seconds1[0]->min);
            }
