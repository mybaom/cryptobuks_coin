...
{
    protected $signature = "\x75\x70\x64\x61\x74\x65\x5F\x62\x61\x6C\x61\x6E\x63\x65";
    protected $description = "\xE6\x9B\xB4\xE6\x96\xB0\xE7\x94\xA8\xE6\x88\xB7\xE4\xBD\x99\xE9\xA2\x9D";
    ...
    public function handle()
    {
        ...
        UsersWallet::chunk(100, function ($wallets) {
            $wallets->each(function ($item, $key) {
                UpdateBalanceJob::dispatch($item);
            });
        });
        $this->comment("执行完成");
    }
